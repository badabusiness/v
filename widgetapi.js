(function () {
    ...
    function Ea(a, b) {
        sa(a.f); var c = a.f.h; if (c) return Fa(a, "return" in c ? c["return"] : function (d) { return { value: d, done: !0 } }, b, a.f["return"]);
    ...
    function Ha(a) {
        this.next = function (b) { sa(a.f); a.f.h ? b = Fa(a, a.f.h.next, b, a.f.m) : (a.f.m(b), b = Ga(a)); return b };
    ...
    t("Promise", function (a) {
        function b(g) { this.f = 0; this.h = void 0; this.g = []; this.m = !1; var h = this.i(); try { g(h.resolve, h.reject) } catch (k) { h.reject(k) } }
        ...
        b.prototype.then = function (g, h) {
            function k(r, q) { return "function" == typeof r ? function (v) { try { l(r(v)) } catch (w) { m(w) } } : q }
            var l, m, p = new b(function (r, q) { l = r; m = q });
            this.J(k(g, l), k(h, m)); return p
        };
        b.prototype["catch"] = function (g) { return this.then(void 0, g) };
        b.prototype.J = function (g, h) {
            function k() { switch (l.f) { case 1: g(l.h); break; case 2: h(l.h); break; default: throw Error("Unexpected state: " + l.f); } }
        ...
        b.all = function (g) {
            var h = u(g), k = h.next(); return k.done ? d([]) : new b(function (l, m) {
                function p(v) { return function (w) { r[v] = w; q--; 0 == q && l(r) } }
    ...
    t("WeakMap", function (a) {
        function b(k) { this.f = (h += Math.random() + 1).toString(); if (k) { k = u(k); for (var l; !(l = k.next()).done;)l = l.value, this.set(l[0], l[1]) } }
        function c() { }
    ...
    t("Set", function (a) {
        function b(c) { this.f = new Map; if (c) { c = u(c); for (var d; !(d = c.next()).done;)this.add(d.value) } this.size = this.f.size }
    ...
    C(ab, Error); ab.prototype.name = "CustomError"; var bb = Array.prototype.indexOf ? function (a, b) { return Array.prototype.indexOf.call(a, b, void 0) } : function (a, b) {
        if ("string" === typeof a) return "string" !== typeof b || 1 != b.length ? -1 : a.indexOf(b, 0);
        for (var c = 0; c < a.length; c++)if (c in a && a[c] === b) return c; return -1
    }, D = Array.prototype.forEach ? function (a, b, c) { Array.prototype.forEach.call(a, b, c) } : function (a, b, c) { for (var d = a.length, e = "string" === typeof a ? a.split("") : a, f = 0; f < d; f++)f in e && b.call(c, e[f], f, a) }, cb = Array.prototype.reduce ? function (a, b, c) { return Array.prototype.reduce.call(a, b, c) } : function (a, b, c) {
        var d = c;
    ...
    var Pb; a: {
        var Qb = "", Rb = function () { var a = F; if (Mb) return /rv:([^\);]+)(\)|;)/.exec(a); if (Lb) return /Edge\/([\d\.]+)/.exec(a); if (Kb) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (Nb) return /WebKit\/(\S+)/.exec(a); if (Jb) return /(?:Version)[ \/]?(\S+)/.exec(a) }();
        Rb && (Qb = Rb ? Rb[1] : ""); if (Kb) { var Sb = Ob(); if (null != Sb && Sb > parseFloat(Qb)) { Pb = String(Sb); break a } } Pb = Qb
    } var $b = Pb, ac = {}, bc; if (y.document && Kb) { var cc = Ob(); bc = cc ? cc : parseInt($b, 10) || void 0 } else bc = void 0; var dc = bc; var ec = G("iPhone") && !G("iPod") && !G("iPad") || G("iPod"), fc = G("iPad"); var gc = {}, hc = null; var H = window; function ic(a) {
        var b = z("window.location.href"); null == a && (a = 'Unknown Error of type "null/undefined"'); if ("string" === typeof a) return { message: a, name: "Unknown error", lineNumber: "Not available", fileName: b, stack: "Not available" }; var c = !1; try { var d = a.lineNumber || a.line || "Not available" } catch (g) { d = "Not available", c = !0 } try { var e = a.fileName || a.filename || a.sourceURL || y.$googDebugFname || b } catch (g) { e = "Not available", c = !0 } b = jc(a); if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            c = a.message; if (null ==
    ...
    function Cc() {
        var a = qc(), b = {}; D(Bc(), function (c) { a.sandbox && a.sandbox.supports && a.sandbox.supports(c) && (b[c] = !0) });
        return b
    }
    ...
    qa(Gc, Fc); Gc.prototype.toString = function () { return this.f }; new Gc("about:blank", Ec); new Gc("about:invalid#zTSz", Ec); var Hc = (new Date).getTime(); function Ic(a) {
    ...
    ; function Kc(a, b, c) {
        var d = [], e = []; if (1 == (Array.isArray(c) ? 2 : 1)) return e = [b, a], D(d, function (h) { e.push(h) }), Lc(e.join(" "));
    ...
    ; function Mc(a) {
        var b = Ic(String(y.location.href)), c; (c = y.__SAPISID || y.__APISID || y.__OVERRIDE_SID) ? c = !0 : (c = new mc(document), c = c.get("SAPISID") || c.get("APISID") || c.get("__Secure-3PAPISID") || c.get("SID"), c = !!c); if (c && (c = (b = 0 == b.indexOf("https:") || 0 == b.indexOf("chrome-extension:") || 0 == b.indexOf("moz-extension:")) ? y.__SAPISID : y.__APISID, c || (c = new mc(document), c = c.get(b ? "SAPISID" : "APISID") || c.get("__Secure-3PAPISID")), c)) {
            b = b ? "SAPISIDHASH" : "APISIDHASH"; var d = String(y.location.href); return d && c && b ? [b, Kc(Ic(d),
                c, a || null)].join(" ") : null
        } return null
    }
    ...
    function Oc(a) {
        -1 == a.f && (a.f = cb(a.g, function (b, c, d) { return c ? b + Math.pow(2, d) : b }, 0));
        return a.f
    }
    ...
    var Sc; function Tc() {
        var a = y.MessageChannel; "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !G("Presto") && (a = function () {
            var e = qc(); e.style.display = "none"; document.documentElement.appendChild(e); var f = e.contentWindow; e = f.document; e.open(); e.close(); var g = "callImmediate" + Math.random(), h = "file:" == f.location.protocol ? "*" : f.location.protocol + "//" + f.location.host; e = Xa(function (k) { if (("*" == h || k.origin == h) && k.data == g) this.port1.onmessage() }, this);
            f.addEventListener("message", e, !1); this.port1 = {}; this.port2 = { postMessage: function () { f.postMessage(g, h) } }
        });
        if ("undefined" !== typeof a && !G("Trident") && !G("MSIE")) {
            var b = new a, c = {}, d = c; b.port1.onmessage = function () { if (void 0 !== c.next) { c = c.next; var e = c.W; c.W = null; e() } };
            return function (e) { d.next = { W: e }; d = d.next; b.port2.postMessage(0) }
    ...
    var Yc; function Zc() {
        if (y.Promise && y.Promise.resolve) { var a = y.Promise.resolve(void 0); Yc = function () { a.then(bd) } } else Yc = function () {
            var b = bd;
    ...
    function yd(a, b, c) {
        c || (c = 0); var d = a.m; if ("string" === typeof b) for (var e = 0; 16 > e; e++)d[e] = b.charCodeAt(c) << 24 | b.charCodeAt(c + 1) << 16 | b.charCodeAt(c + 2) << 8 | b.charCodeAt(c + 3), c += 4; else for (e = 0; 16 > e; e++)d[e] = b[c] << 24 | b[c + 1] << 16 | b[c + 2] << 8 | b[c + 3], c += 4; for (e = 16; 80 > e; e++) { var f = d[e - 3] ^ d[e - 8] ^ d[e - 14] ^ d[e - 16]; d[e] = (f << 1 | f >>> 31) & 4294967295 } b = a.f[0]; c = a.f[1]; var g = a.f[2], h = a.f[3], k = a.f[4]; for (e = 0; 80 > e; e++) {
        ...
        } a.f[0] = a.f[0] + b & 4294967295; a.f[1] = a.f[1] + c & 4294967295; a.f[2] = a.f[2] + g & 4294967295; a.f[3] = a.f[3] + h & 4294967295; a.f[4] = a.f[4] + k & 4294967295
    }
    ...
    function Bd(a) {
        if (a instanceof Ad) return a; if ("function" == typeof a.B) return a.B(!1); if (Qa(a)) {
            var b = 0, c = new Ad; c.next = function () { for (; ;) { if (b >= a.length) throw zd; if (b in a) return a[b++]; b++ } };
            return c
    ...
    function Dd(a) {
        if (Qa(a)) return gb(a); a = Bd(a); var b = []; Cd(a, function (c) { b.push(c) });
        return b
    }
    ...
    n.B = function (a) {
        Gd(this); var b = 0, c = this.i, d = this, e = new Ad; e.next = function () { if (c != d.i) throw Error("The map has changed since the iterator was created"); if (b >= d.f.length) throw zd; var f = d.f[b++]; return a ? f : d.h[f] };
        return e
    }; var Id = !Kb || 9 <= Number(dc), Jd;
    if (Jd = Kb) {
        var Kd; if (Object.prototype.hasOwnProperty.call(ac, "9")) Kd = ac["9"]; else {
            for (var Ld = 0, Md = wb(String($b)).split("."), Nd = wb("9").split("."), Od = Math.max(Md.length, Nd.length), Pd = 0; 0 == Ld && Pd < Od; Pd++) {
                var Qd = Md[Pd] || "", Rd = Nd[Pd] || ""; do {
                    var Sd = /(\d*)(\D*)(.*)/.exec(Qd) || ["", "", "", ""], Td = /(\d*)(\D*)(.*)/.exec(Rd) || ["", "", "", ""]; if (0 == Sd[0].length && 0 == Td[0].length) break; Ld = Eb(0 == Sd[1].length ? 0 : parseInt(Sd[1], 10), 0 == Td[1].length ? 0 : parseInt(Td[1], 10)) || Eb(0 == Sd[2].length, 0 == Td[2].length) || Eb(Sd[2], Td[2]);
                    Qd = Sd[3]; Rd = Td[3]
                } while (0 == Ld)
            } Kd = ac["9"] = 0 <= Ld
        } Jd = !Kd
    } var Ud = Jd, Vd = function () {
        if (!y.addEventListener || !Object.defineProperty) return !1; var a = !1, b = Object.defineProperty({}, "passive", { get: function () { a = !0 } });
        try { y.addEventListener("test", Pa, b), y.removeEventListener("test", Pa, b) } catch (c) { } return a
    }(); function Wd(a, b) { this.type = a; this.f = this.target = b; this.defaultPrevented = this.g = !1 }
    ...
    Xd.prototype.init = function (a, b) {
        var c = this.type = a.type, d = a.changedTouches && a.changedTouches.length ? a.changedTouches[0] : null; this.target = a.target || a.srcElement; this.f = b; var e = a.relatedTarget; if (e) { if (Mb) { a: { try { Ib(e.nodeName); var f = !0; break a } catch (g) { } f = !1 } f || (e = null) } } else "mouseover" == c ? e = a.fromElement : "mouseout" == c && (e = a.toElement); this.relatedTarget = e; d ? (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !== d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY ||
    ...
    function ne() {
        var a = pe, b = Id ? function (c) { return a.call(b.src, b.listener, c) } : function (c) {
    ...
    var ue = "__closure_events_fn_" + (1E9 * Math.random() >>> 0); function ke(a) {
        if ("function" === typeof a) return a; a[ue] || (a[ue] = function (b) { return a.handleEvent(b) });
        return a[ue]
    }
    ...
    function Ee(a) {
        return new K(function (b, c) {
            var d = a.length, e = []; if (d) for (var f = function (l, m) { d--; e[l] = m; 0 == d && b(e) }, g = function (l) { c(l) }, h = 0, k; h < a.length; h++)k = a[h], Ce(k, Ya(f, h), g);
            else b(e)
        })
    }
    ...
    function Fe(a, b, c, d) {
        var e = Ae(null, null, null); e.f = new K(function (f, g) {
            e.g = b ? function (h) { try { var k = b.call(d, h); f(k) } catch (l) { g(l) } } : f;
    ...
    n.B = function (a) {
        var b = 0, c = this.f, d = new Ad; d.next = function () { if (b >= c.length) throw zd; var e = c.key(b++); if (a) return e; e = c.getItem(e); if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return e };
        return d
    };
    ...
    n.B = function (a) {
        var b = 0, c = this.f.XMLDocument.documentElement.attributes, d = new Ad; d.next = function () { if (b >= c.length) throw zd; var e = c[b++]; if (a) return decodeURIComponent(e.nodeName.replace(/\./g, "%")).substr(1); e = e.nodeValue; if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return e };
        return d
    };
    ...
    jf.prototype.B = function (a) {
        var b = this.g.B(!0), c = this, d = new Ad; d.next = function () { for (var e = b.next(); e.substr(0, c.f.length) != c.f;)e = b.next(); return a ? e.substr(c.f.length) : c.g.get(e) };
        return d
    }; var kf = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {}; B("yt.config_", kf); function lf(a) { var b = arguments; 1 < b.length ? kf[b[0]] = b[1] : 1 === b.length && Object.assign(kf, b[0]) }
    ...
    function tf(a) {
        this.type = ""; this.state = this.source = this.data = this.currentTarget = this.relatedTarget = this.target = null; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.ctrlKey = this.altKey = !1; this.clientY = this.clientX = 0; this.changedTouches = this.touches = null; try {
            if (a = a || window.event) {
                this.event = a; for (var b in a) b in sf || (this[b] = a[b]); var c = a.target || a.srcElement; c && 3 == c.nodeType && (c = c.parentNode); this.target = c; var d = a.relatedTarget; if (d) try { d = d.nodeName ? d : null } catch (e) { d = null } else "mouseover" ==
    ...
    function yf(a, b, c) {
        var d = void 0 === d ? {} : d; if (a && (a.addEventListener || a.attachEvent)) {
            var e = vf(a, b, c, d); if (!e) {
                e = ++uf.count + ""; var f = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document); var g = f ? function (h) { h = new tf(h); if (!rc(h.relatedTarget, function (k) { return k == a })) return h.currentTarget = a, h.type = b, c.call(a, h) } : function (h) {
                    h = new tf(h);
    ...
    ; function Bf(a) {
        var b = []; ob(a, function (c, d) { var e = encodeURIComponent(String(d)), f; Array.isArray(c) ? f = c : f = [c]; D(f, function (g) { "" == g ? b.push(e) : b.push(e + "=" + encodeURIComponent(String(g))) }) });
        return b.join("&")
    }
    ...
    function Qg(a) {
        for (var b = Ig, c = Math.round(Dg()), d = Ng.size, e = u(Ng), f = e.next(); !f.done; f = e.next()) {
            var g = u(f.value); f = g.next().value; var h = g.next().value; g = sb({ context: Sg(b.f || Tg()) }); g.events = h; (h = Og[f]) && Ug(g, f, h); delete Og[f]; Vg(g, c); Wg(b, "log_event", g, {
                retry: !0, onSuccess: function () { d--; d || a(); Hg = Math.round(Dg() - c) },
    ...
    function ah(a) {
        var b = a.f; try { var c = b.screenX; var d = b.screenY } catch (p) { } try { var e = b.outerWidth; var f = b.outerHeight } catch (p) { } try { var g = b.innerWidth; var h = b.innerHeight } catch (p) { } b = [b.screenLeft, b.screenTop, c, d, b.screen ? b.screen.availWidth : void 0, b.screen ? b.screen.availTop : void 0, e, f, g, h]; c = a.f.top; try { var k = (c || window).document, l = "CSS1Compat" == k.compatMode ? k.documentElement : k.body; var m = (new oc(l.clientWidth, l.clientHeight)).round() } catch (p) { m = new oc(-12245933, -12245933) } k = m; m = {}; l = new Nc; y.SVGElement &&
    ...
    ; var dh = { Authorization: "AUTHORIZATION", "X-Goog-Visitor-Id": "SANDBOXED_VISITOR_ID", "X-YouTube-Client-Name": "INNERTUBE_CONTEXT_CLIENT_NAME", "X-YouTube-Client-Version": "INNERTUBE_CONTEXT_CLIENT_VERSION", "X-YouTube-Device": "DEVICE", "X-Youtube-Identity-Token": "ID_TOKEN", "X-YouTube-Page-CL": "PAGE_CL", "X-YouTube-Page-Label": "PAGE_BUILD_LABEL", "X-YouTube-Variants-Checksum": "VARIANTS_CHECKSUM" }, eh = "app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address client_dev_root_url".split(" "),
        fh = !1;
    function gh(a, b) {
        b = void 0 === b ? {} : b; if (!c) var c = window.location.href; var d = a.match(sc)[1] || null, e = I(a); d && e ? (d = c, c = a.match(sc), d = d.match(sc), c = c[3] == d[3] && c[1] == d[1] && c[4] == d[4]) : c = e ? I(c) == e && (Number(c.match(sc)[4] || null) || null) == (Number(a.match(sc)[4] || null) || null) : !0; d = R("web_ajax_ignore_global_headers_if_set"); for (var f in dh) e = N(dh[f]), !e || !c && I(a) || d && void 0 !== b[f] || (b[f] = e); if (c || !I(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset()); (c || !I(a)) && (f = "undefined" != typeof Intl ? (new Intl.DateTimeFormat).resolvedOptions().timeZone :
            null) && (b["X-YouTube-Time-Zone"] = f); if (c || !I(a)) b["X-YouTube-Ad-Signals"] = Bf(Yg(void 0)); return b
    }
    function hh(a) {
        var b = window.location.search, c = I(a), d = tc(a.match(sc)[5] || null); d = (c = c && (c.endsWith("youtube.com") || c.endsWith("youtube-nocookie.com"))) && d && d.startsWith("/api/"); if (!c || d) return a; var e = Cf(b), f = {}; D(eh, function (g) { e[g] && (f[g] = e[g]) });
        return ig(a, f || {}, !1)
    }
    function ih(a, b) {
        if (window.fetch && "XML" != b.format) {
            var c = { method: b.method || "GET", credentials: "same-origin" }; b.headers && (c.headers = b.headers); a = jh(a, b); var d = kh(a, b); d && (c.body = d); b.withCredentials && (c.credentials = "include"); var e = !1, f; fetch(a, c).then(function (g) {
                if (!e) {
                    e = !0; f && window.clearTimeout(f); var h = g.ok, k = function (l) { l = l || {}; var m = b.context || y; h ? b.onSuccess && b.onSuccess.call(m, l, g) : b.onError && b.onError.call(m, l, g); b.T && b.T.call(m, l, g) };
                    "JSON" == (b.format || "JSON") && (h || 400 <= g.status && 500 > g.status) ? g.json().then(k, function () { k(null) }) : k(null)
                }
            });
            b.ba && 0 < b.timeout && (f = zf(function () { e || (e = !0, window.clearTimeout(f), b.ba.call(b.context || y)) }, b.timeout))
        } else lh(a, b)
    }
    function lh(a, b) {
        var c = b.format || "JSON"; a = jh(a, b); var d = kh(a, b), e = !1, f = mh(a, function (k) {
            if (!e) {
                e = !0; h && window.clearTimeout(h); a: switch (k && "status" in k ? k.status : -1) { case 200: case 201: case 202: case 203: case 204: case 205: case 206: case 304: var l = !0; break a; default: l = !1 }var m = null, p = 400 <= k.status && 500 > k.status, r = 500 <= k.status && 600 > k.status; if (l || p || r) m = nh(a, c, k, b.La); if (l) a: if (k && 204 == k.status) l = !0; else { switch (c) { case "XML": l = 0 == parseInt(m && m.return_code, 10); break a; case "RAW": l = !0; break a }l = !!m } m = m ||
                    {}; p = b.context || y; l ? b.onSuccess && b.onSuccess.call(p, k, m) : b.onError && b.onError.call(p, k, m); b.T && b.T.call(p, k, m)
            }
    ...
    function kh(a, b) {
        var c = N("XSRF_FIELD_NAME", void 0), d = N("XSRF_TOKEN", void 0), e = b.postBody || "", f = b.u, g = N("XSRF_FIELD_NAME", void 0), h; b.headers && (h = b.headers["Content-Type"]); b.Oa || I(a) && !b.withCredentials && I(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.u && b.u[g] || (f || (f = {}), f[c] = d); f && "string" === typeof e && (e = Cf(e), ub(e, f), e = b.da && "JSON" == b.da ? JSON.stringify(e) : wc(e)); if (!(c = e) && (c = f)) { a: { for (var k in f) { f = !1; break a } f = !0 } c = !f } !fh && c && "POST" != b.method &&
            (fh = !0, pf(Error("AJAX request with postData should use POST"))); return e
    }
    function nh(a, b, c, d) {
        var e = null; switch (b) { case "JSON": try { var f = c.responseText } catch (g) { throw d = Error("Error reading responseText"), d.params = a, qf(d), g; } a = c.getResponseHeader("Content-Type") || ""; f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f)); break; case "XML": if (a = (a = c.responseXML) ? oh(a) : null) e = {}, D(a.getElementsByTagName("*"), function (g) { e[g.tagName] = ph(g) }) }d && qh(e);
        return e
    }
    ...
    function mh(a, b, c, d, e, f, g) {
        function h() { 4 == (k && "readyState" in k ? k.readyState : 0) && b && of(b)(k) }
    ...
    ; function uh(a) {
        a = Object.assign({}, a); delete a.Authorization; var b = Mc(); if (b) {
            var c = new xd; c.update(N("INNERTUBE_API_KEY", void 0)); c.update(b); b = c.digest(); c = 3; Qa(b); void 0 === c && (c = 0); if (!hc) { hc = {}; for (var d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), e = ["+/=", "+/", "-_=", "-_.", "-_"], f = 0; 5 > f; f++) { var g = d.concat(e[f].split("")); gc[f] = g; for (var h = 0; h < g.length; h++) { var k = g[h]; void 0 === hc[k] && (hc[k] = h) } } } c = gc[c]; d = []; for (e = 0; e < b.length; e += 3) {
                var l = b[e], m = (f = e + 1 < b.length) ?
                    b[e + 1] : 0; k = (g = e + 2 < b.length) ? b[e + 2] : 0; h = l >> 2; l = (l & 3) << 4 | m >> 4; m = (m & 15) << 2 | k >> 6; k &= 63; g || (k = 64, f || (m = 64)); d.push(c[h], c[l], c[m] || "", c[k] || "")
            } a.hash = d.join("")
        } return a
    }
    ...
    function U(a) {
        var b = this; this.g = a; this.state = { status: "PENDING" }; this.f = []; this.onRejected = []; this.g(function (c) { if ("PENDING" === b.state.status) { b.state = { status: "FULFILLED", value: c }; c = u(b.f); for (var d = c.next(); !d.done; d = c.next())d = d.value, d() } }, function (c) {
            if ("PENDING" === b.state.status) {
                b.state = {
                    status: "REJECTED",
                    reason: c
                }; c = u(b.onRejected); for (var d = c.next(); !d.done; d = c.next())d = d.value, d()
            }
        })
    }
    ...
    function Wh(a) {
        var b = this; this.f = a; this.g = new Map; this.aborted = !1; this.done = new K(function (c, d) {
            b.f.addEventListener("complete", function () { c() });
    ...
    function Xh(a, b) {
        var c = new K(function (d, e) { Gh(b(a).then(function (f) { a.commit(); d(f) }), e) });
    ...
    n.update = function (a) { return V(this.cursor.update(a)) }; function He(a) {
        function b() { k || (k = new Th(c.result, { closed: h })); return k }
        ...
        return Lh(c).then(function (l) {
            e && l.addEventListener("versionchange", function () { e(b()) });
            f && l.addEventListener("close", function () { f() });
            return b()
        })
    }
    ; var di, ei, fi = ["getAll", "getAllKeys", "getKey", "openKeyCursor"], gi = ["getAll", "getAllKeys", "getKey", "openKeyCursor"]; function hi() {
        return $a(this, function b() {
            var c, d; return Ia(b, function (e) {
                switch (e.g) {
                    case 1: if (Bh && Ch() && !Dh() && !R("ytidb_allow_on_ios_safari_v8_and_v9") || Lb) return e["return"](!1); try { if (c = self, !(c.indexedDB && c.IDBIndex && c.IDBKeyRange && c.IDBObjectStore)) return e["return"](!1) } catch (f) { return e["return"](!1) } va(e); return ua(e, Ge(function () { }));
    ...
    function Wg(a, b, c, d) {
        !N("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && qf(new Nh("Missing VISITOR_DATA when sending innertube request.", b, c, d)); if (!a.isReady()) { var e = new Nh("innertube xhrclient not ready", b, c, d); pf(e); e.sampleWeight = 0; throw e; } var f = {
            headers: { "Content-Type": "application/json" }, method: "POST", u: c, da: "JSON", M: function () { d.M() },
        ...
        }, g = ""; (e = a.f.qa) && (g = e); var h = a.f.sa || !1, k = th(h, g, d); Object.assign(f.headers, k); f.headers.Authorization && !g && (f.headers["x-origin"] = window.location.origin); e = "/youtubei/" + a.f.innertubeApiVersion + "/" + b; var l = { alt: "json" }; a.f.ra && f.headers.Authorization || (l.key = a.f.innertubeApiKey); var m = ig("" + g + e, l || {}, !0); qi().then(function (p) {
            if (d.retry && R("retry_web_logging_batches") && "www.youtube-nocookie.com" != g) {
                if (R("networkless_gel") && !p || !R("networkless_gel")) var r = yh(b,
                    c, k, h); if (r) {
                        var q = f.onSuccess, v = f.aa; f.onSuccess = function (w, E) { zh(r); q(w, E) };
                        c.aa = function (w, E) { zh(r); v(w, E) }
                    }
            } try { R("use_fetch_for_op_xhr") ? ih(m, f) : R("networkless_gel") && d.retry ? (f.method = "POST", oi(m, f)) : (f.method = "POST", f.u || (f.u = {}), lh(m, f)) } catch (w) {
                if ("InvalidAccessError" == w.name) r && (zh(r), r = 0), qf(Error("An extension is blocking network request."));
                else throw w;
            } r && xg(function () { Ah(a) })
        })
    }
    ; var si = [{
        Z: function (a) { return "Cannot read property '" + a.key + "'" },
        U: {
            TypeError: [{ regexp: /Cannot read property '([^']+)' of (null|undefined)/, groups: ["key", "value"] }, { regexp: /\u65e0\u6cd5\u83b7\u53d6\u672a\u5b9a\u4e49\u6216 (null|undefined) \u5f15\u7528\u7684\u5c5e\u6027\u201c([^\u201d]+)\u201d/, groups: ["value", "key"] }, { regexp: /\uc815\uc758\ub418\uc9c0 \uc54a\uc74c \ub610\ub294 (null|undefined) \ucc38\uc870\uc778 '([^']+)' \uc18d\uc131\uc744 \uac00\uc838\uc62c \uc218 \uc5c6\uc2b5\ub2c8\ub2e4./, groups: ["value", "key"] }, {
                regexp: /No se puede obtener la propiedad '([^']+)' de referencia nula o sin definir/,
                groups: ["key"]
            }, { regexp: /Unable to get property '([^']+)' of (undefined or null) reference/, groups: ["key", "value"] }], Error: [{ regexp: /(Permission denied) to access property "([^']+)"/, groups: ["reason", "key"] }]
        }
    }, {
        Z: function (a) { return "Cannot call '" + a.key + "'" },
        U: {
    ...
    ; function W(a, b, c) {
        this.l = this.f = this.g = null; this.j = Ra(this); this.h = 0; this.o = !1; this.m = []; this.i = null; this.v = c; this.G = {}; c = document; if (a = "string" === typeof a ? c.getElementById(a) : a) if (c = "iframe" == a.tagName.toLowerCase(), b.host || (b.host = c ? uc(a.src) : "https://www.youtube.com"), this.g = new rg(b), c || (b = Ai(this, a), this.l = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.f = a, this.f.id || (this.f.id = "widget" + Ra(this.f)), lg[this.f.id] = this, window.postMessage) {
            this.i = new M; Bi(this); b = Q(this.g, "events"); for (var d in b) b.hasOwnProperty(d) &&
    ...
    function Ai(a, b) {
        for (var c = document.createElement("iframe"), d = b.attributes, e = 0, f = d.length; e < f; e++) { var g = d[e].value; null != g && "" != g && "null" != g && c.setAttribute(d[e].name, g) } c.setAttribute("frameBorder", 0); c.setAttribute("allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope"); c.setAttribute("title", "YouTube " + Q(a.g, "title")); (d = Q(a.g, "width")) && c.setAttribute("width", d); (d = Q(a.g, "height")) && c.setAttribute("height", d); var h =
            a.P(); h.enablejsapi = window.postMessage ? 1 : 0; window.location.host && (h.origin = window.location.protocol + "//" + window.location.host); h.widgetid = a.j; window.location.href && D(["debugjs", "debugcss"], function (k) {
                var l = window.location.href; var m = l.search(xc); b: { var p = 0; for (var r = k.length; 0 <= (p = l.indexOf(k, p)) && p < m;) { var q = l.charCodeAt(p - 1); if (38 == q || 63 == q) if (q = l.charCodeAt(p + r), !q || 61 == q || 38 == q || 35 == q) break b; p += r + 1 } p = -1 } if (0 > p) l = null; else {
                    r = l.indexOf("&", p); if (0 > r || r > m) r = m; p += k.length + 1; l = decodeURIComponent(l.substr(p,
                        r - p).replace(/\+/g, " "))
                } null !== l && (h[k] = l)
            });
    ...
    n.V = function (a) {
        a.id = this.j; a.channel = "widget"; var b = we(a), c = this.g, d = uc(this.f.src || ""); var e = 0 == d.indexOf("https:") ? [d] : c.f ? [d.replace("http:", "https:")] : c.h ? [d] : [d, d.replace("http:", "https:")]; if (this.f.contentWindow) for (var f = 0; f < e.length; f++)try { this.f.contentWindow.postMessage(b, e[f]) } catch (Ka) {
            if (Ka.name && "SyntaxError" == Ka.name) {
                if (!(Ka.message && 0 < Ka.message.indexOf("target origin ''"))) {
                    var g = void 0, h = void 0, k = Ka; h = void 0 === h ? {} : h; h.name = N("INNERTUBE_CONTEXT_CLIENT_NAME", 1); h.version = N("INNERTUBE_CONTEXT_CLIENT_VERSION",
                        void 0); var l = h || {}, m = "WARNING"; m = void 0 === m ? "ERROR" : m; g = void 0 === g ? !1 : g; if (k) {
                            if (R("console_log_js_exceptions")) { var p = k, r = []; r.push("Name: " + p.name); r.push("Message: " + p.message); p.hasOwnProperty("params") && r.push("Error Params: " + JSON.stringify(p.params)); r.push("File name: " + p.fileName); r.push("Stacktrace: " + p.stack); window.console.log(r.join("\n"), p) } if ((window && window.yterr || g) && !(5 <= xi) && 0 !== k.sampleWeight) {
                                var q = void 0, v = k, w = l, E = ic(v), Sa = E.message || "Unknown Error", fa = E.name || "UnknownError",
                                Da = E.lineNumber || "Not available", Ki = E.fileName || "Not available", Li = E.stack || v.f || "Not available"; if (v.hasOwnProperty("args") && v.args && v.args.length) for (var na = 0, Tb = 0; Tb < v.args.length; Tb++) {
                                    var O = v.args[Tb], za = "params." + Tb; na += za.length; if (O) if (Array.isArray(O)) { for (var Mi = w, cd = na, hb = 0; hb < O.length && !(O[hb] && (cd += zi(hb, O[hb], za, Mi), 500 < cd)); hb++); na = cd } else if ("object" === typeof O) { var Ub = void 0, Ni = w, dd = na; for (Ub in O) if (O[Ub] && (dd += zi(Ub, O[Ub], za, Ni), 500 < dd)) break; na = dd } else w[za] = String(JSON.stringify(O)).substring(0,
                                        500), na += w[za].length; else w[za] = String(JSON.stringify(O)).substring(0, 500), na += w[za].length; if (500 <= na) break
                                } else if (v.hasOwnProperty("params") && v.params) { var Vb = v.params; if ("object" === typeof v.params) { var Df = 0; for (q in Vb) if (Vb[q]) { var Ef = "params." + q, Ff = String(JSON.stringify(Vb[q])).substr(0, 500); w[Ef] = Ff; Df += Ef.length + Ff.length; if (500 < Df) break } } else w.params = String(JSON.stringify(Vb)).substr(0, 500) } navigator.vendor && !w.hasOwnProperty("vendor") && (w.vendor = navigator.vendor); var ed = {
                                    message: Sa, name: fa,
                                    lineNumber: Da, fileName: Ki, stack: Li, params: w
                                    ...
                                    Aa; window.yterr && "function" === typeof window.yterr && window.yterr(Y); if (!(wi.has(Y.message) || 0 <= Y.stack.indexOf("/YouTubeCenter.js") || 0 <= Y.stack.indexOf("/mytube.js"))) {
                                        vi.K("handleError", Y); if (R("kevlar_gel_error_routing")) {
                                            var Xb = void 0, Lf = m, L = Y; a: { for (var Mf = u(yi), jd = Mf.next(); !jd.done; jd = Mf.next()) { var Nf = F; if (Nf && 0 <= Nf.toLowerCase().indexOf(jd.value.toLowerCase())) { var Of = !0; break a } } Of = !1 } if (!Of) {
                                                var ib = { stackTrace: L.stack }; L.fileName && (ib.filename = L.fileName); var Z = L.lineNumber && L.lineNumber.split ?
                                                    L.lineNumber.split(":") : []; 0 !== Z.length && (1 !== Z.length || isNaN(Number(Z[0])) ? 2 !== Z.length || isNaN(Number(Z[0])) || isNaN(Number(Z[1])) || (ib.lineNumber = Number(Z[0]), ib.columnNumber = Number(Z[1])) : ib.lineNumber = Number(Z[0])); var Oi = L.message, Pi = L.name; ui || (ui = new ti); var Pf = ui; a: {
                                                        for (var Qf = u(Pf.g), kd = Qf.next(); !kd.done; kd = Qf.next()) { var Rf = kd.value; if (L.message && L.message.match(Rf.f)) { var ld = Rf.weight; break a } } for (var Sf = u(Pf.f), md = Sf.next(); !md.done; md = Sf.next()) {
                                                            var Tf = md.value; if (Tf.f(L)) {
                                                                ld = Tf.weight;
                                                                break a
                                                            }
                                                        } ld = 1
                                                    } var nd = { level: "ERROR_LEVEL_UNKNOWN", message: Oi, errorClassName: Pi, sampleWeight: ld }; "ERROR" === Lf ? nd.level = "ERROR_LEVEL_ERROR" : "WARNING" === Lf && (nd.level = "ERROR_LEVEL_WARNNING"); var Qi = { isObfuscated: !0, browserStackInfo: ib }, Ma = { pageUrl: window.location.href }; N("FEXP_EXPERIMENTS") && (Ma.experimentIds = N("FEXP_EXPERIMENTS")); Ma.kvPairs = []; var od = L.params; if (od) for (var Uf = u(Object.keys(od)), pd = Uf.next(); !pd.done; pd = Uf.next()) { var Vf = pd.value; Ma.kvPairs.push({ key: "client." + Vf, value: String(od[Vf]) }) } var Wf =
                                                        N("SERVER_NAME", void 0), Xf = N("SERVER_VERSION", void 0); Wf && Xf && (Ma.kvPairs.push({ key: "server.name", value: Wf }), Ma.kvPairs.push({ key: "server.version", value: Xf })); var Ri = { errorMetadata: Ma, stackTrace: Qi, logMessage: nd }; Xb = void 0 === Xb ? {} : Xb; var Yf = ri; N("ytLoggingEventsDefaultDisabled", !1) && ri == ri && (Yf = null); var Si = Yf, T = Xb; T = void 0 === T ? {} : T; var jb = {}; jb.eventTimeMs = Math.round(T.timestamp || Dg()); jb.clientError = Ri; var Ti = String; if (T.timestamp) var Zf = -1; else {
                                                            var $f = z("_lact", window); Zf = null == $f ? -1 : Math.max(Date.now() -
                                                                $f, 0)
                                                        } jb.context = { lastActivityMs: Ti(Zf) }; if (R("log_sequence_info_on_gel_web") && T.fa) { var Ui = jb.context, kb = T.fa; Xg[kb] = kb in Xg ? Xg[kb] + 1 : 0; Ui.sequence = { index: Xg[kb], groupKey: kb }; T.Na && delete Xg[T.fa] } var Vi = jb, Yb = T.Ma, ag = Si, qd = ""; if (Yb) { var Zb = Yb, rd = {}; Zb.videoId ? rd.videoId = Zb.videoId : Zb.playlistId && (rd.playlistId = Zb.playlistId); Og[Yb.token] = rd; qd = Yb.token } var sd = Ng.get(qd) || []; Ng.set(qd, sd); sd.push(Vi); ag && (Ig = new ag); var Wi = vg("web_logging_max_batch") || 100, bg = Dg(); sd.length >= Wi ? Pg() : 10 <= bg - Lg && (Rg(),
                                                            Lg = bg); Pg()
                                            }
                                        } if (!R("suppress_error_204_logging")) {
                                            var td, Ba = Y, lb = Ba.params || {}, oa = { ua: { a: "logerror", t: "jserror", type: Ba.name, msg: Ba.message.substr(0, 250), line: Ba.lineNumber, level: m, "client.name": lb.name }, u: { url: N("PAGE_NAME", window.location.href), file: Ba.fileName }, method: "POST" }; lb.version && (oa["client.version"] = lb.version); if (oa.u) {
                                                Ba.stack && (oa.u.stack = Ba.stack); for (var cg = u(Object.keys(lb)), ud = cg.next(); !ud.done; ud = cg.next()) { var dg = ud.value; oa.u["client." + dg] = lb[dg] } if (td = N("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",
                                                    void 0)) for (var eg = u(Object.keys(td)), vd = eg.next(); !vd.done; vd = eg.next()) { var fg = vd.value; oa.u[fg] = td[fg] } var gg = N("SERVER_NAME", void 0), hg = N("SERVER_VERSION", void 0); gg && hg && (oa.u["server.name"] = gg, oa.u["server.version"] = hg)
                                            } lh(N("ECATCHER_REPORT_HOST", "") + "/error_204", oa)
                                        } wi.add(Y.message); xi++
                                    }
                            }
                        }
    ...
    }; function Fi(a) { return (0 === a.search("cue") || 0 === a.search("load")) && "loadModule" !== a }
    ...
    function Ii(a, b) {
        D(b, function (c) {
            this[c] || ("getCurrentTime" == c ? this[c] = function () { var d = this.playerInfo.currentTime; if (1 == this.playerInfo.playerState) { var e = (Date.now() / 1E3 - this.playerInfo.currentTimeLastUpdated_) * this.playerInfo.playbackRate; 0 < e && (d += Math.min(e, 1)) } return d } : Fi(c) ? this[c] = function () {
                this.playerInfo = {};
                this.C = {}; Ei(this, c, arguments); return this
            } : Gi(c) ? this[c] = function () {
                var d = 0;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || og(); var Zi = y.onYTReady; Zi && Zi(); var $i = y.onYouTubeIframeAPIReady; $i && $i(); var aj = y.onYouTubePlayerAPIReady; aj && aj();
}).call(this);
